...
Stata 측 설치·라이선스·서버 기동([README.md](README.md) 1~3장)은 먼저 마쳐야 합니다.

> **먼저 확인** — [README.md](README.md) 4-1 의 확장 프로그램(mcpb)을 설치했다면
> 채팅에서도 대부분 그대로 동작합니다 (Node 등 추가 설치 불필요). 확장이 도구
> 목록에 안 보이는 환경에서만 아래의 수동 등록을 사용하세요. 아래 방식은
> Node 22 이상이 필요합니다.

> 스킬([README.md](README.md) 4-2)은 채팅에서도 사용할 수 있습니다. 다만 이 스킬들은
