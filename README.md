...
- [skill-bundles/](skill-bundles) — (선택) 코워크 슬래시 명령 스킬 6종 (`/stata-setup`, `/stata-exec`, `/stata-pull`, `/stata-data-fullcontext`, `/stata-graph-get`, `/stata-instruction`) — 등록 방법은 INSTALL.md 7장 참고
